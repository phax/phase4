 ...
 */
public final class MainPhase4PeppolSenderConstantReceiver extends AbstractPhase4Sender
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderConstantReceiver.class);
