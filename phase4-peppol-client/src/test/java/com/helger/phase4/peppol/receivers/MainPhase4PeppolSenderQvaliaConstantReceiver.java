 ...
 */
public final class MainPhase4PeppolSenderQvaliaConstantReceiver extends AbstractPhase4Sender
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderQvaliaConstantReceiver.class);
