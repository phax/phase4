 ...
 */
public final class MainPhase4PeppolSenderConstantReceiverSG
{
  private static final Logger LOGGER = LoggerFactory.getLogger (MainPhase4PeppolSenderConstantReceiverSG.class);
  ...
  public static void main (final String [] args)
  {
    ...
    {
      final Element aPayloadElement = DOMReader.readXMLDOM (new File ("src/test/resources/examples/Singapore invoice valid 1.xml"))
                                               .getDocumentElement ();
      if (aPayloadElement == null)
        throw new IllegalStateException ();

      // Start configuring here
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("0195:ocbcTester9000");
      if (Phase4PeppolSender.builder ()
                            ...
                            .setReceiverEndpointDetails (CertificateHelper.convertStringToCertficate ("-----BEGIN CERTIFICATE-----\n" +
                                                                                                      ...
                                                                                                      "-----END CERTIFICATE-----"),
                                                         "https://peppol-dev.ps-dev.strands.com/api-hub/as4")
