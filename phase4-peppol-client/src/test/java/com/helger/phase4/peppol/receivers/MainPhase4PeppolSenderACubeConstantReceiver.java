 ...
 */
public final class MainPhase4PeppolSenderACubeConstantReceiver extends AbstractPhase4Sender
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderACubeConstantReceiver.class);
