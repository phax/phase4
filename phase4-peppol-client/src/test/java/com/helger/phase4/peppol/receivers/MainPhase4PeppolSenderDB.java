...
/**
 * Example for sending something to the Deutsche Bahn [DE] test endpoint.
 *
 * @author Philip Helger
 */
public final class MainPhase4PeppolSenderDB
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderDB.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("9915:db-test");
