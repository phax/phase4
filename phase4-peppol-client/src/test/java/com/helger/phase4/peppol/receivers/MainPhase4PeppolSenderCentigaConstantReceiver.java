...
/**
 * Example for sending something to the Conta/Centiga/Intunor [NO] test endpoint.
 *
 * @author Philip Helger
 */
public final class MainPhase4PeppolSenderCentigaConstantReceiver extends AbstractPhase4Sender
{
