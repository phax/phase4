...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (MainPhase4PeppolSenderGenerix.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("9915:generixtest");
