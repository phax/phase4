 ...
 */
public final class MainPhase4PeppolSenderConstantReceiverSG2 extends AbstractPhase4Sender
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderConstantReceiverSG2.class);
