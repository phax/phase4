...
/**
 * Example for sending something to the Effect (BE) test endpoint.
 *
 * @author Philip Helger
 */
public final class MainPhase4PeppolSenderEffect
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderEffect.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("0208:1000033673");
