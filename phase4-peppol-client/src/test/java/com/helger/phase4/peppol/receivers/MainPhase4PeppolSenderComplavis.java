...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (MainPhase4PeppolSenderComplavis.class);
  ...
  public static void send ()
  {
    try
    {
      ...
      // 0106:32070687
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("9998:complavis1");
