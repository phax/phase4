 ...
 */
public final class MainPhase4PeppolSenderHorus
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderHorus.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("0208:0478696879");
