 ...
 */
public final class MainPhase4PeppolSenderHelgerTSR
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderHelgerTSR.class);

  public static void send ()
  {
    try
    {
      final Element aPayloadElement = DOMReader.readXMLDOM (new File ("src/test/resources/external/examples/reporting/transaction-statistics-minimal.xml"))
                                               .getDocumentElement ();
