 ...
 */
public final class MainPhase4PeppolSenderQvaliaOrder
{
  private static final Logger LOGGER = LoggerFactory.getLogger (MainPhase4PeppolSenderQvaliaOrder.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      eResult = Phase4PeppolSender.builder ()
                                  ...
                                  .validationConfiguration (PeppolValidation2024_05.VID_OPENPEPPOL_ORDER_V3,
