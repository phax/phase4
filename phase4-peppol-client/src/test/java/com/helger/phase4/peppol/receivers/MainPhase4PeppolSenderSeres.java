 ...
 */
public final class MainPhase4PeppolSenderSeres
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderSeres.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("9915:seres-test");
      ...
      eResult = Phase4PeppolSender.builder ()
                                  ...
                                  .validationConfiguration (null, null)
