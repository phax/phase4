 ...
 */
public final class MainPhase4PeppolSenderLocalHost8080WithMLS extends AbstractPhase4Sender
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderLocalHost8080WithMLS.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      final EAS4UserMessageSendResult eResult = Phase4PeppolSender.builder ()
                                                                  ...
                                                                  .mlsTo (Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("9999:123456"))
                                                                  .mlsType (EPeppolMLSType.ALWAYS_SEND)
