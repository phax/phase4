 ...
 */
public final class MainPhase4PeppolSenderB4Value
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderB4Value.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("0204:661-68-56");
