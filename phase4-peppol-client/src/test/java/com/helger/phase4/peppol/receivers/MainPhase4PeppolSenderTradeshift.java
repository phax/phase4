...
/**
 * Example for sending something to the Tradeshift test endpoint.
 *
 * @author Philip Helger
 */
public final class MainPhase4PeppolSenderTradeshift
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderTradeshift.class);
