...
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderATGov.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      final Element aPayloadElement = DOMReader.readXMLDOM (new File ("src/test/resources/external/examples/at-gov-peppol-ubl.xml"))
                                               .getDocumentElement ();
