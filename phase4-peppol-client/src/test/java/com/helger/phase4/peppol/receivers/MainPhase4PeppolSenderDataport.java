 ...
 */
public final class MainPhase4PeppolSenderDataport
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderDataport.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme (false ? "0204:04011000-961-87"
                                                                                                                           : "0204:01-2004-73");
