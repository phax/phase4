...
/**
 * Example for sending something to the LDI [DE] test endpoint.
 *
 * @author Philip Helger
 */
public final class MainPhase4PeppolSenderLDI
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderLDI.class);
