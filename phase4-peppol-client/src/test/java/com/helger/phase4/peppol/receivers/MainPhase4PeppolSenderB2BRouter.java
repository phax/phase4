...
/**
 * Example for sending something to the B2BRouter test endpoint.
 *
 * @author Philip Helger
 */
public final class MainPhase4PeppolSenderB2BRouter
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderB2BRouter.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("9920:esb63354724");
