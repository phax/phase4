...
/**
 * Example for sending something to the Horus Software (BE) test endpoint.
 *
 * @author Philip Helger
 */
public final class MainPhase4PeppolSenderDSoft
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderDSoft.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      final IParticipantIdentifier aReceiverID = Phase4PeppolSender.IF.createParticipantIdentifierWithDefaultScheme ("0088:3000000000002");
