 ...
 */
public final class MainPhase4PeppolSenderHelgerLargeFileLocal extends AbstractPhase4Sender
{
  ...
  public static void send ()
  {
    try
    {
      ...
      eResult = Phase4PeppolSender.builder ()
                                  ...
                                  .receiverEndpointDetails (pem2certPHG3 (), "http://localhost:8080/as4")
