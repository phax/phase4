...
/**
 * Example for sending something to the Albert Patron [LU] Test endpoint.
 *
 * @author Philip Helger
 */
public final class MainPhase4PeppolSenderAlbertPatronConstantReceiver extends AbstractPhase4Sender
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderAlbertPatronConstantReceiver.class);
