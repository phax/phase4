 ...
 */
public final class MainPhase4PeppolSenderSGConstantReceiver extends AbstractPhase4Sender
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderSGConstantReceiver.class);
