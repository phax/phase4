 ...
 */
public final class MainPhase4PeppolSenderStorecoveConstantReceiver extends AbstractPhase4Sender
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderStorecoveConstantReceiver.class);
