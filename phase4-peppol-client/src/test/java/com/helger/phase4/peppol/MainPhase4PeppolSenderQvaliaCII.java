...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (MainPhase4PeppolSenderQvaliaCII.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      final Element aPayloadElement = DOMReader.readXMLDOM (new File ("src/test/resources/examples/cii/cii-en-qvalia.xml"))
                                               .getDocumentElement ();
      ...
      eResult = Phase4PeppolSender.builder ()
                                  ...
                                  .validationConfiguration (EN16931Validation.VID_CII_137, new Phase4PeppolValidatonResultHandler ())
