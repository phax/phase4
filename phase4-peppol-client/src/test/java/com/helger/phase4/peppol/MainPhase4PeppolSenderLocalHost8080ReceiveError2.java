 ...
 */
public final class MainPhase4PeppolSenderLocalHost8080ReceiveError2 extends AbstractPhase4Sender
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderLocalHost8080ReceiveError2.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      final EAS4UserMessageSendResult eResult = Phase4PeppolSender.builder ()
                                                                  ...
                                                                  /*
                                                                   * Special handling by this
                                                                   * receiver only
                                                                   */
                                                                  .addMessageProperty (MessageProperty.builder ()
                                                                                                      .name ("MockErrorStatusCode")
                                                                                                      .value ("502"))
