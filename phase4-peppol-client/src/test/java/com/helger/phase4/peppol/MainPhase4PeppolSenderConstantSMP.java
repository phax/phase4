 ...
 */
public final class MainPhase4PeppolSenderConstantSMP
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4PeppolSenderConstantSMP.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      ...
      eResult = Phase4PeppolSender.builder ()
                                  ...
                                  // Ignore DNS lookup
                                  .smpClient (new SMPClientReadOnly (URLHelper.getAsURI ("http://smp.helger.com")))
