...
/**
 * Example for sending something to the Storecove Test endpoint.
 *
 * @author Philip Helger
 */
public final class MainPhase4PeppolSenderStorecove
{
  private static final Logger LOGGER = LoggerFactory.getLogger (MainPhase4PeppolSenderStorecove.class);
