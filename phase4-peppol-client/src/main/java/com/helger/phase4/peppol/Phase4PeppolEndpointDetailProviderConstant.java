...
/**
 * An implementation of {@link IPhase4PeppolEndpointDetailProvider} that uses
 * constant values.
 *
 * @author Philip Helger
 * @since 0.9.7
 */
public class Phase4PeppolEndpointDetailProviderConstant implements IPhase4PeppolEndpointDetailProvider
{
  private final X509Certificate m_aReceiverCert;
  private final String m_sDestURL;

  public Phase4PeppolEndpointDetailProviderConstant (@Nullable final X509Certificate aReceiverCert,
