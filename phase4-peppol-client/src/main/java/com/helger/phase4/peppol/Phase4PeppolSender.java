...
/**
 * This class contains all the specifics to send AS4 messages to the Peppol
 * Network. See <code>sendAS4Message</code> as the main method to trigger the
...
public final class Phase4PeppolSender
{
   ...
   *        Possibility to override the usage of revocation result caching flag
   *        on a per query basis. Use {@link ETriState#UNDEFINED} to solely use
   *        the global flag.
   * @param eCheckMode
                                                                ...
                                                                AbstractAS4UserMessageBuilderMIMEPayload <IMPLTYPE>
  {
    ...
    /**
     * Set an optional Consumer for the technical contact retrieved from the
     * endpoint details provider, independent of its usability.
     *
