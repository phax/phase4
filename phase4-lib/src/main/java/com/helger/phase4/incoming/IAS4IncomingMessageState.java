...
public interface IAS4IncomingMessageState
{
  ...
  /**
   * @return The SOAP version of the current request as specified in the constructor. Never
   *         <code>null</code>.
   * @since v0.9.8
   */
  @NonNull
  ...
  /**
   * @return The parent of the user message/signal message for further evaluation.
   */
  @Nullable
  ...
  /**
   * @return the PMode that is used with the current message. May be <code>null</code> if none was
   *         found.
   */
  @Nullable
  IPMode getPMode ();
  ...
  /**
   * @return get the original SOAP document, only the entire document no attachment. This might by
   *         encrypted.
  ...
  /**
   * @return <code>true</code> if an original SOAP document is present, <code>false</code> if not.
  ...
  /**
   * @return has saved the original attachment, can be encrypted or not depends if encryption is
   *         used or not.
  ...
  /**
   * @return <code>true</code> if original attachments are present, <code>false</code> if not.
  ...
  /**
   * @return get the decrypted SOAP document, only the entire document no attachment
  ...
  /**
   * @return <code>true</code> of a decrypted SOAP document is present, <code>false</code> if not.
   * @see #getDecryptedSoapDocument()
   * @see #getOriginalSoapDocument()
   */
  ...
  /**
   * @return Getting decrypted attachment, if there were encrypted attachments to begin with. May be
   *         <code>null</code>.
   * @see #getOriginalAttachments()
   */
  @Nullable
  ...
  /**
   * @return <code>true</code> if a decrypted attachments are present, <code>false</code> if not.
   */
  ...
  /**
   * @return IDs from all compressed attachments and/or payload. May be <code>null</code>.
   */
  @Nullable
   ...
   * @return Looks up if a compression mode with the id sID exists and returns the mode else
   *         <code>null</code>
   */
  @Nullable
  ...
  /**
   * @return the MPC that is used in the current message exchange. May be <code>null</code>.
   */
  @Nullable
  IMPC getMPC ();
  ...
  /**
   * @return <code>true</code> if a payload in the soap body is present, else <code>false</code>
   * @see #getSoapBodyPayloadNode()
   */
  boolean isSoapBodyPayloadPresent ();

  /**
   * @return initiator set in the usermessage if the incoming message is a UserMessage. This is the
  ...
  /**
   * @return <code>true</code> if an initiator ID was part of the UserMessage, <code>false</code> if
   *         not.
   * @see #getInitiatorID()
   */
  default boolean hasInitiatorID ()
  {
    return StringHelper.isNotEmpty (getInitiatorID ());
  }

  /**
   * @return responder set in the usermessage if the incoming message is a UserMessage. This is the
  ...
  /**
   * @return <code>true</code> if a responder ID was part of the UserMessage, <code>false</code> if
   *         not.
   * @see #getResponderID()
   */
  default boolean hasResponderID ()
  {
    return StringHelper.isNotEmpty (getResponderID ());
  }

  /**
   * @return The signing certificate in the incoming message. May be <code>null</code>.
  ...
  /**
   * @return <code>true</code> if a signing certificate is provided, <code>false</code> if not.
  ...
  /**
   * @return <code>true</code> if a decrypting certificate is provided, <code>false</code> if not.
  ...
  /**
   * @return The effective leg to use. May be leg 1 or leg 2 of the PMode. If no PMode was found, no
   *         PModeLeg is present.
   * @see #getPMode()
   */
  @Nullable
  ...
  /**
   * @return 1 or 2, depending on the used leg. Any other value indicates "undefined". If no PMode
   *         was found, no PModeLeg is present.
  ...
  /**
   * @return A bit set of the WSS4J security action tags found. 0 for nothing. See class
   *         org.apache.wss4j.dom.WSContants line 326ff for the constants.
   * @since v0.9.8
   */
  @Nonnegative
  ...
  /**
   * @return <code>true</code> if the incoming message was signed and the signature was verified,
   ...
   *         this is a <code>org.apache.wss4j.common.ext.WSSecurityException</code> exception
   *         something happened on the security level.
   * @since 0.9.11
   */
  @Nullable
  ...
  /**
   * @return <code>true</code> if a SOAP WSS4J exception is present, <code>false</code> if not.
  ...
  /**
   * @return The phase4 profile to be used. May be <code>null</code> in case it could not be
   *         determined.
   * @since v2.5.3
   */
  @Nullable
  ...
  /**
   * @return The AS4 message ID. Source is the <code>MessageInfo</code> element. May be
   *         <code>null</code>.
   * @since v0.9.7
   */
  @Nullable
  ...
  /**
   * @return The AS4 "reference to message ID". This value is optional in the headers. Source is the
   *         <code>MessageInfo</code> element. May be <code>null</code>.
   * @since v1.2.0
   */
  @Nullable
  ...
  /**
   * @return The AS4 provided message timestamp. This value is mandatory in the source
   *         <code>MessageInfo</code> element. May be <code>null</code>.
   * @since v1.2.0
   */
  @Nullable
  ...
  /**
   * @return <code>true</code> if the incoming message is an AS4 ping message, <code>false</code>
   *         otherwise.
   * @since v0.9.7
   */
  ...
  /**
   * @return The child of the SOAP Body node or <code>null</code>. That is always decrypted.
   * @since v0.9.8
   */
  @Nullable
  ...
  /**
   * @return <code>true</code> if SOAP header element processing was successful, <code>false</code>
   *         if not. If not, than many other values are also not set and at least one error is in
   *         the error list.
   * @since v0.9.7
   */
  ...
  /**
   * @return The crypto factory that was used to verify an eventually contained signature. May be
   *         <code>null</code>. If this is non-<code>null</code> it is NO indicator, whether a
   *         message was signed or not.
  ...
  /**
   * @return The crypto factory that was used to decrypt an eventually encrypted message. May be
   *         <code>null</code>. If this is non-<code>null</code> it is NO indicator, whether a
