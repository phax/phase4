...
/**
 * Specialized interface for the Payload Attachments consumer.
 *
 * @author Jon Rios
 * @since 2.7.5
 */
@FunctionalInterface
public interface IAS4AttachmentConsumer
{
  /**
   ...
   *         in case of error
   */
  void handleAttachments (@Nonnull List<WSS4JAttachment> aAttachments,
