...
public interface IPhase4HREDeliveryIncomingSBDHandlerSPI
{
   ...
   * @param aHREDeliverySBD
   *        The pre-parsed HR eDelivery Standard Business Document. Never <code>null</code>.
   * @param aDocTypeID
   *        The document type ID provided in the AS4 message. Never <code>null</code>.
   * @param aProcessID
   *        The process ID provided in the AS4 message. Never <code>null</code>.
   * @param aState
   ...
   *        The AS4 message ID of the response. Neither <code>null</code> nor empty.
