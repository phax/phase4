...
public class PModeLegErrorHandling implements Serializable
{
  ...
  public final void setReportSenderErrorsTo (@Nullable final PModeAddressList aReportSenderErrorsTo)
  {
  ...
  public final void setReportReceiverErrorsTo (final PModeAddressList aReportReceiverErrorsTo)
  {
  ...
  public final void setReportAsResponse (final boolean eReportAsResponse)
  {
    setReportAsResponse (ETriState.valueOf (eReportAsResponse));
  }

  public final void setReportAsResponse (@Nonnull final ETriState eReportAsResponse)
  {
  ...
  public final void setReportProcessErrorNotifyConsumer (final boolean eReportProcessErrorNotifyConsumer)
  {
    setReportProcessErrorNotifyConsumer (ETriState.valueOf (eReportProcessErrorNotifyConsumer));
  }

  public final void setReportProcessErrorNotifyConsumer (@Nonnull final ETriState eReportProcessErrorNotifyConsumer)
  {
  ...
  public final void setReportProcessErrorNotifyProducer (final boolean eReportProcessErrorNotifyProducer)
  {
    setReportProcessErrorNotifyProducer (ETriState.valueOf (eReportProcessErrorNotifyProducer));
  }

  public final void setReportProcessErrorNotifyProducer (@Nonnull final ETriState eReportProcessErrorNotifyProducer)
  {
  ...
  public final void setReportDeliveryFailuresNotifyProducer (final boolean eReportDeliveryFailuresNotifyProducer)
  {
    setReportDeliveryFailuresNotifyProducer (ETriState.valueOf (eReportDeliveryFailuresNotifyProducer));
  }

  public final void setReportDeliveryFailuresNotifyProducer (@Nonnull final ETriState eReportDeliveryFailuresNotifyProducer)
  {
