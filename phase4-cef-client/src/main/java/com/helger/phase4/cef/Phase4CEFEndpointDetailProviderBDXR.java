 ...
 * @since 0.9.15
 */
public class Phase4CEFEndpointDetailProviderBDXR implements IPhase4CEFEndpointDetailProvider
{
  ...
  public Phase4CEFEndpointDetailProviderBDXR (@Nonnull final IBDXRServiceMetadataProvider aSMPClient)
  {
   ...
   */
  @Nonnull
  public final Phase4CEFEndpointDetailProviderBDXR setTransportProfile (@Nonnull final ISMPTransportProfile aTP)
  {
