...
/**
 * An implementation of {@link IPhase4CEFEndpointDetailProvider} that uses
 * constant values.
 *
 * @author Philip Helger
 * @since 0.9.15
 */
public class Phase4CEFEndpointDetailProviderConstant implements IPhase4CEFEndpointDetailProvider
{
  private final X509Certificate m_aReceiverCert;
  private final String m_sDestURL;

  public Phase4CEFEndpointDetailProviderConstant (@Nullable final X509Certificate aReceiverCert, @Nonnull @Nonempty final String sDestURL)
  {
