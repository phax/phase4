...
The exception is the AEAT webinar of 2026-09-10, for which no documents have been published yet;
content attributed to it comes from notes taken from the live slides and is flagged as unverified
wherever it is used.
...
| Tier | Who | Transport |
|---|---|---|
| Public hub - **SPFE** (*Solucion Publica de Facturacion Electronica*), run by AEAT | anybody; mandatory recipient of "faithful copies" of all invoices | synchronous **web services** (WSDL on the AEAT Sede electronica) + web form, authenticated with electronic certificates. Not AS4, but per the 2026-09-10 webinar the envelope is genuine **ebMS 3.0 over SOAP 1.2** with eBCore party IDs and CID-referenced MIME payloads, presented as "compatible AS4 / Peppol" and carrying no WS-Security at all. |
...
* 2026-09-10 - AEAT webinar "Actualizacion sobre la SPFE" (no documents published on the page at the time of writing; slide content known only from notes)
...
The 2026-09-10 webinar showed this as concrete dates: 2027-10-01 e-invoicing and payment
reporting for turnover > EUR 8 m; 2028-10-01 e-invoicing for the rest plus payment reporting
for incorporated SMEs; 2029-10-01 payment reporting for the remaining small taxpayers.
Draft dates from slides, not verified against published text.
