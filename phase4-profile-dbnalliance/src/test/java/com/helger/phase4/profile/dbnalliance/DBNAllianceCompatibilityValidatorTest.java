 ...
 */
public final class DBNAllianceCompatibilityValidatorTest
{
  @ClassRule
  public static final PhotonAppWebTestRule RULE = new PhotonAppWebTestRule ();

  private static final Locale LOCALE = Locale.US;
  private static final DBNAllianceCompatibilityValidator VALIDATOR = new DBNAllianceCompatibilityValidator ();
  ...
  public void before ()
  {
    ...
    m_aPMode = DBNAlliancePMode.createDBNAlliancePMode ("TestInitiator",
                                                        "TestResponder",
                                                        "http://localhost:8080",
