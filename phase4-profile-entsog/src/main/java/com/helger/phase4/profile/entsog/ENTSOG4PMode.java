...
public final class ENTSOG4PMode
{
  ...
  /**
   * Generate PMode leg security for the ENTSOG 4.0 primary profile (EdDSA/X25519).
   *
  ...
  /**
   * Generate PMode leg security for the ENTSOG 4.0 alternative profile (ECDSA/ECDH-ES).
   *
   * @return Never <code>null</code>.
   */
  @NonNull
  ...
  /**
   * @return GZIP payload service. ENTSOG 4.0 recommends (SHOULD) GZIP compression.
   */
  @NonNull
  ...
  /**
   * One-Way Version of the ENTSOG 4.0 pmode uses one-way push
   *
   * @param sInitiatorID
   *        Initiator ID
   * @param sResponderID
   ...
   */
  @NonNull
  public static PMode createENTSOG4PMode (@NonNull @Nonempty final String sInitiatorID,
  ...
  /**
   * Two-Way Version of the ENTSOG 4.0 pmode uses two-way push-push
   *
   * @param sInitiatorID
   *        Initiator ID
   * @param sResponderID
   ...
   */
  @NonNull
  public static PMode createENTSOG4PModeTwoWay (@NonNull @Nonempty final String sInitiatorID,
                                                @NonNull @Nonempty final String sResponderID,
                                                @Nullable final String sResponderAddress,
                                                @NonNull final IPModeIDProvider aPModeIDProvider,
                                                final boolean bPersist,
