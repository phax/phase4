 ...
 */
public class Phase4DBNAllianceException extends Phase4Exception
{
  /**
   * @param sMessage
   *        Error message
   ...
   *        Optional causing exception
   */
  public Phase4DBNAllianceException (@Nonnull final String sMessage, @Nullable final Throwable aCause)
  {
