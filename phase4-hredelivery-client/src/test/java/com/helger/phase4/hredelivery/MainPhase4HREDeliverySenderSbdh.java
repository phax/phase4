 ...
 */
public final class MainPhase4HREDeliverySenderSbdh
{
  private static final Logger LOGGER = Phase4LoggerFactory.getLogger (MainPhase4HREDeliverySenderSbdh.class);
  ...
  public static void main (final String [] args)
  {
    ...
    try
    {
      final HREDeliverySBDHData aSbdh = new HREDeliverySBDHDataReader (PeppolIdentifierFactory.INSTANCE).extractData (new FileSystemResource ("src/test/resources/external/examples/base-sbdh.xml"));
      if (aSbdh == null)
